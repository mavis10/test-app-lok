        ...
        <div class="page-title d-flex">
         ...
         <div class="header-elements d-none">
            <div class="d-flex justify-content-center">
                <a href="/translations" class="btn btn-link btn-float text-default"><i class="icon-grid6 text-primary"></i><span>View all translations</span></a>
            </div>
        </div>
    </div>
</div>
<div class="content">   
    <div class="card">
        ...
        <div class="card-body">
            <form action="#"  id="frmTranslation" data-parsley-validate=""  data-translationid ='{{$arrTranslationDetails->translationID}}'>
                <div class="row">
                    <div class="col-md-10">
                           @include('translation.translationForm')
                    </div>
                </div>
            </form>  
...
<script src="/js/modules/translation/update.js"></script>
@endsection
