...
<div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Language</span> Edit</h4>
            <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
        </div>
         <div class="header-elements d-none">
            <div class="d-flex justify-content-center">
                <a href="/languages" class="btn btn-link btn-float text-default"><i class="icon-grid6 text-primary"></i><span>View all languages</span></a>
            </div>
        </div>
    </div>
</div>
<div class="content">   
    <div class="card">
        ...
        <div class="card-body">
            <form action="#"  id="frmLanguage" data-parsley-validate=""  data-LanguageID ='{{$arrLanguageDetails->languageID}}'>
                <div class="row">
                    <div class="col-md-10">
...
<script src="/js/modules/language/update.js"></script>
@endsection
