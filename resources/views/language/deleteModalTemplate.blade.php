                    ...
                    <div class="col-md-10 offset-md-1">
                        <div class="col-12" align='center' style='margin-bottom:16px;'>
                         ...
                         <div class="col-12" align='center' >
                           Are you sure you want to delete the language <strong><span id="spanName"></span></strong>.
                        </div>   
                    </div> 
                </div> 
                <form action="#" id="frmLanguage" data-parsley-validate="" data-languageid="" data-languagename=""></form>
            </div>
